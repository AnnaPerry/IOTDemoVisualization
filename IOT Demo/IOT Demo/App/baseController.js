'use strict';
app.controller('baseController', ['$scope', '$http', 'dataService','$interval', function ($scope, $http, dataService,$interval) {
    ...
    function startDataPosts() {

        if (angular.isDefined(stop)) return;

        $interval(function () { dataService.sendDatatoPI() }, 3000);
    };
